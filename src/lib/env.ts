const REQUIRED: Record<string, string | undefined> = {
  ...
  NEXT_PUBLIC_STRIPE_SCRIBE_MONTHLY_CAD:
    process.env.NEXT_PUBLIC_STRIPE_SCRIBE_MONTHLY_CAD,
  NEXT_PUBLIC_STRIPE_SCRIBE_ANNUAL_USD:
    process.env.NEXT_PUBLIC_STRIPE_SCRIBE_ANNUAL_USD,
  NEXT_PUBLIC_STRIPE_SCRIBE_ANNUAL_CAD:
    process.env.NEXT_PUBLIC_STRIPE_SCRIBE_ANNUAL_CAD,
  NEXT_PUBLIC_STRIPE_ARCANE_MONTHLY_USD:
    process.env.NEXT_PUBLIC_STRIPE_ARCANE_MONTHLY_USD,
  NEXT_PUBLIC_STRIPE_ARCANE_MONTHLY_CAD:
    process.env.NEXT_PUBLIC_STRIPE_ARCANE_MONTHLY_CAD,
  NEXT_PUBLIC_STRIPE_ARCANE_ANNUAL_USD:
    process.env.NEXT_PUBLIC_STRIPE_ARCANE_ANNUAL_USD,
  NEXT_PUBLIC_STRIPE_ARCANE_ANNUAL_CAD:
    process.env.NEXT_PUBLIC_STRIPE_ARCANE_ANNUAL_CAD,
};
