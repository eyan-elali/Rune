...
export const UNLOCKABLES: Unlockable[] = [
  ...
  { id: 'midnight-library',   name: 'Midnight Library',   type: 'theme', tier: 'scribe', description: 'Deep navy and silver. The library after hours.',                  requirement: { type: 'level', value: 3 } },
  { id: 'crimson-ink',        name: 'Crimson Ink',        type: 'theme', tier: 'scribe', description: 'Dark reds and bone white. Dramatic and intense.',                 requirement: { type: 'level', value: 5 } },
  ...
  { id: 'obsidian',           name: 'Obsidian',           type: 'theme', tier: 'scribe', description: 'Pure blacks and ice blue. Cold and precise.',                     requirement: { type: 'level', value: 8 } },
  { id: 'ivory-tower',        name: 'Ivory Tower',        type: 'theme', tier: 'scribe', description: "Bone white and charcoal. The scholar's clean desk.",              requirement: { type: 'level', value: 10 } },
  { id: 'absinthe',           name: 'Absinthe',           type: 'theme', tier: 'scribe', description: 'Deep emerald and gold. Decadent and otherworldly.',               requirement: { type: 'level', value: 12 } },
  ...
  { id: 'gilded-age',         name: 'Gilded Age',         type: 'theme', tier: 'scribe', description: 'Rich burgundy and hammered gold. Opulent.',                       requirement: { type: 'level', value: 15 } },
